...
export default function ConceptsIndexPage() {
  // This route exists under app/ only while the local concept server runs.
  if (!isConceptLabAvailable()) notFound();

  return (
    <main id="main-content" tabIndex={-1} className="overflow-x-hidden bg-paper pt-32 md:pt-40">
