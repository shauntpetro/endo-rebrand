...
export default function SystemicMap({ theme = "light" }: { theme?: "light" | "dark" }) {
  ...
  return (
    <div ref={visRef as React.RefObject<HTMLDivElement>} className={`w-full h-full relative ${isDark ? 'bg-plum-dark/50 border-plum-primary/30' : 'bg-bone border-plum-dark/10'} overflow-hidden rounded-lg border group transition-colors duration-500`}>
      ...
      <div
        ...
        <div className="flex items-center gap-4 mb-3">
          <div className="flex items-center gap-2">
            <div className={`w-3 h-3 rounded-full ${isDark ? 'bg-gold-primary' : 'bg-plum-primary'}`} />
