                    ...
                    return (
                        <g transform={`translate(${p.x}, ${p.y})`}>
                             <motion.line 
                                ...
                                strokeWidth="2" 
                             />
                             <rect x="-70" y="-32" width="140" height="32" rx="16" fill={MECHANISM_COLORS.peptideActive} />
              ...
              <g transform={`translate(${padding + (hoveredIndex / (WEEKS.length - 1)) * (width - 2 * padding)}, 0)`}>
                  ...
                  >
                      ...
                      <foreignObject x={hoveredIndex > 3 ? -190 : 10} y={padding} width="180" height="120">
                          <div className="bg-white/95 backdrop-blur text-stone-800 p-3 rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-stone-200 text-xs">
