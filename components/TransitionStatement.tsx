  ...
  return (
    <div ref={containerRef} className="relative h-[250vh]">
      <div className="sticky top-0 h-screen overflow-hidden w-full">
        ...
        <motion.div 
          className="absolute inset-0 bg-black-primary flex items-center justify-center overflow-hidden"
          style={{ clipPath }}
        >
          {/* Atmospheric Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-plum-primary via-[#2E263A] to-black-primary" />
