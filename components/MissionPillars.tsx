...
const pillars = [
  {
    ...
    description: "Developing the first non-hormonal therapeutic with curative potential for endometriosis — designed to eliminate both the disease and its associated symptoms.",
    link: "/pipeline",
    icon: "❈" // Stylized icon
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-plum-primary/20 border-x border-plum-primary/20">
