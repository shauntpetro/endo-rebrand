...
export default function Footer() {
  return (
    <footer role="contentinfo" aria-label="Site footer" className="bg-plum-dark text-white pt-16 lg:pt-24 pb-12 border-t border-plum-dark relative overflow-hidden">
       {/* Background Decor */}
       <div aria-hidden="true" className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-gold-primary/5 rounded-full blur-3xl translate-y-1/2 translate-x-1/4 pointer-events-none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            <motion.div variants={staggerItem} className="lg:col-span-4 mb-2 lg:mb-0">
              ...
              <div className="flex items-center space-x-2 text-gold-primary font-mono text-xs uppercase tracking-widest">
                 <span aria-hidden="true" className="w-2 h-2 rounded-full bg-gold-primary animate-pulse motion-reduce:animate-none" />
                 <span>Irvine, CA</span>
              </div>
            </motion.div>

            {/* Link columns — 3-col on mobile, fits into 12-col on desktop */}
            <nav aria-label="Footer" className="grid grid-cols-3 lg:contents gap-6">
              <motion.div variants={staggerItem} className="lg:col-span-2 lg:col-start-7">
                <h2 className="font-bold mb-4 lg:mb-8 text-xs uppercase tracking-widest text-gold-primary font-sans">Platform</h2>
              ...
              <motion.div variants={staggerItem} className="lg:col-span-2">
                <h2 className="font-bold mb-4 lg:mb-8 text-xs uppercase tracking-widest text-gold-primary font-sans">Company</h2>
                <ul className="space-y-3 lg:space-y-4 text-sm text-gray-300 font-medium font-sans">
              ...
              <motion.div variants={staggerItem} className="lg:col-span-2">
                <h2 className="font-bold mb-4 lg:mb-8 text-xs uppercase tracking-widest text-gold-primary font-sans">Connect</h2>
                <ul className="space-y-3 lg:space-y-4 text-sm text-gray-300 font-medium font-sans">
