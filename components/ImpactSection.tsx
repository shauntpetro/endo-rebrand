...
export default function ImpactSection() {
  return (
    <section className="bg-gradient-to-b from-plum-primary to-plum-dark text-white border-b border-white/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-32 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            >
              {[
                ...
                >
                  ...
                  <div className="text-[10px] text-white/40 font-mono uppercase tracking-wider">{stat.desc}</div>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
          ...
          >
            <p className="text-2xl md:text-4xl text-white/90 leading-tight font-normal mb-16 font-sans border-l-2 border-gold-primary pl-8">
            ...
            >
              {/* Card 1 */}
              <motion.div 
                className="group relative bg-white/5 border border-white/10 p-8 md:p-10 rounded-sm overflow-hidden hover:border-gold-primary/30 transition-colors duration-500"
              ...
              >
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
                   <div className="w-16 h-16 rounded-full bg-white/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-500 flex-shrink-0">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
                   ...
                   <div>
                      ...
                      <p className="text-white/70 leading-relaxed font-sans">
                        A disease-modifying "curable" therapy, built to detect and treat the root cause of disease, not just the symptoms.
                      </p>
                   </div>
                </div>
              </motion.div>
