...
export default function ImpactPage() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-cream-primary flex flex-col font-sans overflow-x-hidden selection:bg-plum-primary selection:text-white">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center bg-cream-primary overflow-hidden pt-32 pb-20">
        {/* Grain Overlay */}
        <div className="absolute inset-0 opacity-[0.03] pointer-events-none mix-blend-multiply">
             <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-50 brightness-100 contrast-150" />
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            >
                ...
                <motion.div 
                    style={{ y: yBackground }}
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full pointer-events-none select-none z-0 flex items-center justify-center"
                >
                ...
                <motion.p 
                    style={{ y: yForeground }}
                    className="relative z-10 text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto leading-relaxed mb-12"
                >
                ...
                >
                    <button className="group relative px-8 py-4 bg-plum-primary text-white text-sm font-bold uppercase tracking-widest rounded-sm overflow-hidden shadow-xl shadow-plum-primary/20 w-full md:w-auto">
                        <div className="absolute inset-0 bg-white/10 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
                        <span className="relative z-10 flex items-center gap-2">
                            Read the Report <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </span>
                    </button>
                </motion.div>
            </motion.div>
                ...
                {stats.map((stat, i) => (
                    <motion.div
                        ...
                        className={`
                            ...
                            shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(74,63,92,0.1)]
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                >
                     ...
                     <h2 className="text-5xl md:text-6xl font-serif font-bold mb-8 text-plum-primary leading-tight">
                        "This is where the <br/> <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-gold-primary to-plum-primary pr-4">spiral</span> begins."
                    </h2>
                    ...
                    <div className="mt-12 p-8 bg-cream-primary/50 rounded-xl border-l-2 border-plum-primary">
                        <p className="text-xl font-serif italic text-plum-primary mb-6">
                            "They’re given treatment after treatment that doesn’t work, because no one’s looking at the disease underneath."
                        </p>
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="relative h-[600px] bg-gray-50 rounded-2xl overflow-hidden shadow-2xl"
                >
                    {/* Image Placeholder */}
                    <div className="absolute inset-0 bg-[url('/standard-mri.jpg')] bg-cover bg-center opacity-20 mix-blend-multiply grayscale" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
                ...
                <div className="lg:col-span-7 space-y-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {group.items.map((item, j) => (
                                            <span key={j} className="px-4 py-1.5 bg-white/5 rounded-full text-sm text-gray-300 font-light border border-white/10 group-hover:border-gold-primary/30 transition-colors">
                                                {item}
                                            </span>
                                        ))}
                                    </div>
                    ...
                    <p className="mt-12 text-sm text-gray-400 italic border-t border-white/10 pt-8 max-w-lg">
                        "A small percentage of patients develop endometriosis-associated ovarian cancer, a rare but serious malignancy that often arises from deep or longstanding disease."
                    </p>
                </div>
            </div>
        </div>
      ...
      <section className="py-40 px-6 relative overflow-hidden flex items-center justify-center bg-cream-primary">
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
            ...
            >
                ...
                <div className="relative p-12 md:p-20 bg-white shadow-2xl shadow-plum-primary/5 rounded-sm border-y-4 border-gold-primary/20">
         ...
         <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            >
                ...
                <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-16 font-light leading-relaxed">
                    "Each lesion triggers inflammation and a cascade of signaling that spreads beyond the tissue itself. We can’t treat endometriosis as if it’s isolated. The impact is global."
                </p>
                
                <div className="inline-block relative group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-gold-primary to-plum-primary rounded-lg blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200" />
